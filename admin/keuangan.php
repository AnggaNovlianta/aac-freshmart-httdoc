<?php
session_start();
$page_title = "Dashboard Keuangan"; // Judul ini akan digunakan oleh header
require '../_includes/db_connection.php';

// Ambil semua menu KEUANGAN yang aktif dari database, urutkan berdasarkan order_number
$menus_query = "SELECT * FROM keuangan_menus WHERE is_active = 1 ORDER BY order_number ASC";
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div>
        <h1 class="h2">Modul Keuangan</h1>
        <p class="text-muted">Pilih salah satu menu di bawah untuk memulai pengelolaan keuangan.</p>
    </div>
</div>
    ...
    <?php else: ?>
        <div class="col-12">
            <div class="alert alert-warning">
                Belum ada menu keuangan yang bisa ditampilkan. Silakan tambahkan menu terlebih dahulu melalui 
                <a href="menu_keuangan_management.php">Pengaturan Menu Keuangan</a>.
            </div>
        </div>
    <?php endif; ?>
