<?php
session_start();
$page_title = "Pengaturan Menu Pengguna";
require '../_templates/admin_header.php';

// Ambil semua menu dari tabel USER_MENUS
$menus_query = "SELECT * FROM user_menus ORDER BY order_number ASC, title ASC";
$menus_result = $conn->query($menus_query);
?>
<!-- Konten di sini adalah salinan dari menu_management.php, tetapi dimodifikasi -->
<!-- untuk menargetkan tabel 'user_menus' dan file proses 'process_user_menu.php' -->
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><?php echo $page_title; ?></h1>
    <button type="button" class="btn btn-sm btn-primary" id="addMenuBtn"><i class="fa fa-plus"></i> Tambah Menu Pengguna</button>
</div>
<!-- Notifikasi, Tabel, Modal, JS (Sama seperti menu_management.php tapi action form menuju 'process_user_menu.php') -->
<!-- Notifikasi -->
...
<div class="card shadow-sm">
    <div class="card-body">
        <p class="text-muted">Atur menu yang akan ditampilkan sebagai ikon di halaman utama dashboard User. Urutkan berdasarkan nomor (semakin kecil, semakin di atas).</p>
...
<div class="modal fade" id="menuModal" tabindex="-1" aria-labelledby="menuModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="menuForm" action="../_process/process_user_menu.php" method="POST">
...
<form id="deleteForm" action="../_process/process_user_menu.php" method="POST" style="display: none;"><input type="hidden" name="action" value="delete"><input type="hidden" name="id" id="delete-id"></form>
