<?php
session_start();
$page_title = "Pengaturan Menu Keuangan";
require '../_includes/db_connection.php';

// Ambil semua menu dari tabel KEUANGAN_MENUS, urutkan
$menus_query = "SELECT * FROM keuangan_menus ORDER BY order_number ASC, title ASC";
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <button type="button" class="btn btn-sm btn-primary" id="addMenuBtn">
            <i class="fa fa-plus"></i> Tambah Menu Keuangan Baru
        </button>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <p class="text-muted">Atur menu yang akan ditampilkan sebagai ikon di halaman Keuangan. Urutkan berdasarkan nomor (semakin kecil, semakin di atas).</p>
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><i class="<?php echo htmlspecialchars($menu['icon_class']); ?> fa-2x text-success"></i></td>
...
<div class="modal fade" id="menuModal" tabindex="-1" aria-labelledby="menuModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header"><h5 class="modal-title" id="menuModalLabel">Form Menu Keuangan</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
      <form id="menuForm" action="../_process/process_menu_keuangan.php" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3"><label for="form-url" class="form-label">URL Tujuan</label><input type="text" name="url" id="form-url" class="form-control" placeholder="Contoh: daftar_tagihan.php" required></div>
...
<form id="deleteForm" action="../_process/process_menu_keuangan.php" method="POST" style="display: none;"><input type="hidden" name="action" value="delete"><input type="hidden" name="id" id="delete-id"></form>

<?php
ob_start(); 
?>
<script>
// JavaScript ini sama persis dengan menu_management.php, tidak perlu diubah.
